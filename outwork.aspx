<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="outwork.aspx.cs" Inherits="SonBus.outwork" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
   <title>STAR Group ABOUT</title>
...
<body>
   <div id="main">
    ...
    <div id="site_content">
       <ul class="slideshow">
        <li class="show"><img width="880" color="blue" height="350" src="images/home_1.jpg" alt="&quot;Your companion is always with you !!!&quot;" /></li>
	  ...
	  <div id="content">
        <div class="content_item">
          ...
          <h2>ABOUT</h2>
            <div style="width:60px; float:left;"><img src="images/icons/news.png" alt="work"/></div>
			<p>Access from everywhere in Turkey since 2014 we provide, and we will further increase our transport network by providing continuous development</p>
            <h3>Our services</h3>
    	      <ul>
   			    <li>Service 1 - Quality of drivers and assistants</li>
    		    <li>Service 2 - Food</li>
   			    <li>Service 3 - Quality recreational facilities</li>
                <li>Service 4 - High customer satisfaction</li>
